...
class Material(db.Model):
    ...
    lessons = db.relationship('Lesson', backref='material', cascade='all, delete-orphan', lazy=True)
...
class Lesson(db.Model):
    ...
    title = db.Column(db.String(100), nullable=False)
    description = db.Column(db.Text)
    problems = db.relationship('Problem', backref='lesson', cascade='all, delete-orphan', lazy=True)
